...
use App\Filament\Resources\Finances\ExpenseResource\Pages;
use App\Filament\Resources\Finances\ExpenseResource\RelationManagers;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Tabs::make('Tabs')
                    ->tabs([
                        Tabs\Tab::make('Expenses Information')
                            ->icon('heroicon-o-shopping-bag')
                            ->schema([
                                self::expenseDetailsSection(),
                            ]),
                        Tabs\Tab::make('Receipt & OCR')
                ...
                Repeater::make('items')
                    ...
                    ->schema([
                        ...
                        TextInput::make('quantity')
                            ...
                            ->reactive()
                            ->default(1)
                            ->afterStateUpdated(function (\Filament\Forms\Set $set, $state, callable $get) {
